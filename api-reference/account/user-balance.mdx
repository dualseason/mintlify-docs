---
title: "查询用户余额"
description: "- 查询用户账户的总体剩余额度和已使用额度"
---
...
<RequestExample>
  ...
  curl --request GET \
    --url 'https://XCompute.us/v1/user/balance' \
  ...
  const API_BASE = 'https://XCompute.us';
  ...
  public class Main {
      public static void main(String[] args) throws Exception {
          String url = "https://XCompute.us/v1/user/balance";
  ...
  $ch = curl_init('https://XCompute.us/v1/user/balance');
  ...
  url = URI("https://XCompute.us/v1/user/balance")
  ...
  let url = URL(string: "https://XCompute.us/v1/user/balance")!
  ...
  class Program
  {
      static async Task Main(string[] args)
      {
          ...
          var url = "https://XCompute.us/v1/user/balance";
