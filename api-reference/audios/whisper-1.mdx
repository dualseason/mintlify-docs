...
<RequestExample>
  ...
  curl --request POST \
    --url https://XCompute.us/v1/audio/transcriptions \
  ...
  const url = "https://XCompute.us/v1/audio/transcriptions";
  ...
  public class Main {
      public static void main(String[] args) throws Exception {
          String url = "https://XCompute.us/v1/audio/transcriptions";
  ...
  url = URI("https://XCompute.us/v1/audio/transcriptions")
  ...
  let url = URL(string: "https://XCompute.us/v1/audio/transcriptions")!
  ...
  class Program
  {
      ...
      {
          var url = "https://XCompute.us/v1/audio/transcriptions";
  ...
  int main(void) {
      ...
      if(curl) {
          curl_easy_setopt(curl, CURLOPT_URL, "https://XCompute.us/v1/audio/transcriptions");
  ...
  int main(int argc, const char * argv[]) {
      @autoreleasepool {
          NSURL *url = [NSURL URLWithString:@"https://XCompute.us/v1/audio/transcriptions"];
  ...
  let url = "https://XCompute.us/v1/audio/transcriptions"
  ...
  void main() async {
    final url = Uri.parse('https://XCompute.us/v1/audio/transcriptions');
