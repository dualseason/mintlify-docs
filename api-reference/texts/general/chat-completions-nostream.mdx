---
title: "通用对话接口(默认非流式)"
description: "- 统一的对话API接口，支持所有文本生成模型"
---
...
<RequestExample>
  ...
  curl --request POST \
    --url https://XCompute.us/api/v1/chat/completions \
  ...
  const url = "https://XCompute.us/api/v1/chat/completions";
  ...
  public class Main {
      public static void main(String[] args) throws Exception {
          String url = "https://XCompute.us/api/v1/chat/completions";
  ...
  url = URI("https://XCompute.us/api/v1/chat/completions")
  ...
  let url = URL(string: "https://XCompute.us/api/v1/chat/completions")!
  ...
  class Program
  {
      ...
      {
          var url = "https://XCompute.us/api/v1/chat/completions";
  ...
  int main(void) {
      ...
      if(curl) {
          const char *url = "https://XCompute.us/api/v1/chat/completions";
          // 可替换为任意支持的模型 ID
          const char *payload = "{"
              "\"model\":\"gpt-4o\","
              "\"stream\":false,"
  ...
  int main(int argc, const char * argv[]) {
      @autoreleasepool {
          NSURL *url = [NSURL URLWithString:@"https://XCompute.us/api/v1/chat/completions"];
  ...
  let url = "https://XCompute.us/api/v1/chat/completions"
  ...
  void main() async {
    final url = Uri.parse('https://XCompute.us/api/v1/chat/completions');
