...
<RequestExample>
  ...
  curl --request POST \
    ...
    --data '{
      ...
      "image_urls": ["https://cdn.apimart.ai/doc/sora-2-preview.png"]
    }'
  ```
  ...
  func main() {
      ...
      payload := map[string]interface{}{
          ...
          "duration":     8,
          "aspect_ratio": "landscape",
          "image_urls":   []string{"https://cdn.apimart.ai/doc/sora-2-preview.png"},
      }
  ...
  int main(void) {
      ...
      if(curl) {
          const char *url = "https://XCompute.us/v1/videos/generations";
          const char *payload = "{"
              "\"model\":\"sora-2-preview\","
              "\"prompt\":\"A majestic waterfall cascading down rocky cliffs, creating a beautiful rainbow in the mist\","
              "\"duration\":8,"
  ...
  int main(int argc, const char * argv[]) {
      @autoreleasepool {
          NSURL *url = [NSURL URLWithString:@"https://XCompute.us/v1/videos/generations"];
  ...
  let url = "https://XCompute.us/v1/videos/generations"
  ...
  void main() async {
    final url = Uri.parse('https://XCompute.us/v1/videos/generations');
  ...
  payload <- list(
    ...
    duration = 8,
    aspect_ratio = "landscape",
    image_urls = c("https://cdn.apimart.ai/doc/sora-2-preview.png")
  )
...
<ParamField body="image_urls" type="array<url>">
  ...
  * 如必须使用参考图片，请确保参考图片本身是目标宽高比
  ...
  示例：`["https://cdn.apimart.ai/doc/sora-2-preview.png"]`
...
* **计费方式**：按视频时长（秒）计费
* **具体价格**：请参考 [定价页面](https://XCompute.us/console/model/sora-2)
