---
title: "查询令牌余额"
description: "- 查询当前 API Key 的剩余额度和已使用额度"
---
...
<RequestExample>
  ...
  curl --request GET \
    --url 'https://XCompute.us/v1/balance' \
  ...
  public class Main {
      public static void main(String[] args) throws Exception {
          String url = "https://XCompute.us/v1/balance";
  ...
  $ch = curl_init('https://XCompute.us/v1/balance');
  ...
  url = URI("https://XCompute.us/v1/balance")
  ...
  let url = URL(string: "https://XCompute.us/v1/balance")!
  ...
  class Program
  {
      static async Task Main(string[] args)
      {
          ...
          var url = "https://XCompute.us/v1/balance";
