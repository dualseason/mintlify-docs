...
<RequestExample>
  ...
  const url = "https://XCompute.us/v1/audio/speech";
  ...
  public class Main {
      public static void main(String[] args) throws Exception {
          String url = "https://XCompute.us/v1/audio/speech";
  ...
  url = URI("https://XCompute.us/v1/audio/speech")
  ...
  let url = URL(string: "https://XCompute.us/v1/audio/speech")!
  ...
  class Program
  {
      ...
      {
          var url = "https://XCompute.us/v1/audio/speech";
  ...
  int main(void) {
      ...
      if(curl) {
          ...
          curl_easy_setopt(curl, CURLOPT_URL, "https://XCompute.us/v1/audio/speech");
  ...
  int main(int argc, const char * argv[]) {
      @autoreleasepool {
          NSURL *url = [NSURL URLWithString:@"https://XCompute.us/v1/audio/speech"];
  ...
  let url = "https://XCompute.us/v1/audio/speech"
  ...
  void main() async {
    final url = Uri.parse('https://XCompute.us/v1/audio/speech');
