...
description: "- 完全兼容 OpenAI Responses API 格式"
---
...
<RequestExample>
  ...
  curl https://XCompute.us/v1/responses \
  ...
  url = "https://XCompute.us/v1/responses"
  ...
  const url = "https://XCompute.us/v1/responses";
  ...
  public class Main {
      public static void main(String[] args) throws Exception {
          String url = "https://XCompute.us/v1/responses";
  ...
  url = URI("https://XCompute.us/v1/responses")
  ...
  let url = URL(string: "https://XCompute.us/v1/responses")!
  ...
  class Program
  {
      ...
      {
          var url = "https://XCompute.us/v1/responses";
  ...
  int main(void) {
      ...
      if(curl) {
          const char *url = "https://XCompute.us/v1/responses";
          const char *payload = "{"
              "\"model\":\"gpt-5\","
  ...
  int main(int argc, const char * argv[]) {
      @autoreleasepool {
          NSURL *url = [NSURL URLWithString:@"https://XCompute.us/v1/responses"];
  ...
  let url = "https://XCompute.us/v1/responses"
  ...
  void main() async {
    final url = Uri.parse('https://XCompute.us/v1/responses');
