---
title: "Gemini 原生格式"
description: "- 使用 Google 原生 API 格式调用 Gemini 模型"
---
...
<RequestExample>
  ...
  const url = "https://XCompute.us/v1beta/models/gemini-2.5-pro:generateContent";
  ...
  public class Main {
      public static void main(String[] args) throws Exception {
          String url = "https://XCompute.us/v1beta/models/gemini-2.5-pro:generateContent";
  ...
  url = URI("https://XCompute.us/v1beta/models/gemini-2.5-pro:generateContent")
